...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chartify-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `chartify` can be installed with:

```
conda install chartify
```

It is possible to list all of the versions of `chartify` available on your platform with:
